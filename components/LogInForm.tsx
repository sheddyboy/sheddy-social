    ...
    <div className="max-w-xs mx-auto grow -mt-24 relative">
      ...
      <Card>
        <form onSubmit={handleSubmit} className="">
          ...
          <button className="relative flex justify-center items-center mx-auto mt-4 rounded-md bg-socialBlue text-white py-2 px-8">
            <span className={!loading ? "opacity-100" : "opacity-0"}>
              {loggingIn ? "Logging In..." : "LogIn"}
            </span>
            {loading && (
              <div className="absolute">
                <BounceLoader size={25} color="#fff" />
              </div>
            )}
          </button>
        </form>
      ...
      <p className="text-right text-gray-500">
        ...
        <Link className="text-socialBlue" href="/register">
          Register
        </Link>
      </p>
